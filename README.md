...
router.post('v1/webhooks/radial/risk-order-status', xmlBodyParser(), function (req, res, next) {
...
router.post('v1/webhooks/radial/payment-settlement-status', xmlBodyParser(), function (req, res, next) {
