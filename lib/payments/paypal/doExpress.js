...
(function () {
  ...
  DoExpress.execute = function (options, fn) {
    ...
    var doExpressUrl = params.uriBaseDomain + '/v' + params.apiVersion + '/stores/' + params.storeCode +
    ...
    if (options.pickUpStoreId && typeof options.pickUpStoreId === 'string') {
      postBodyJson.elements[0].elements.push({
        type: 'element',
        name: 'PickUpStoreId',
        elements: [{
          type: 'text',
          text: options.pickUpStoreId
        }]
      });
    }
    ...
    sendRequest({
      ...
      return fn(null, {
        ...
        paymentInfo: {
          paymentStatus: reply.PaymentInfo.PaymentStatus._text,
          paymentReason: reply.PaymentInfo.PaymentReason._text,
          paymentCode: reply.PaymentInfo.PaymentCode._text
        }
      });
    });
  };
