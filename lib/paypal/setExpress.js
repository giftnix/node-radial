...
(function () {
  ...
  SetExpress.execute = function (options, fn) {
    ...
    var setExpressUrl = params.uriBaseDomain + '/v' + params.apiVersion + '/stores/' + params.storeCode +
    ...
    var lineItemsXml = [{
      ...
      elements: [{
        type: 'text',
        text: options.shippingTotal.toString()
      }]
    }, {
      type: 'element',
      name: 'TaxTotal',
      ...
      elements: [{
        type: 'text',
        text: options.taxTotal.toString()
      }]
    }];
    ...
    console.log(postBodyJson.elements[0]);

    var xmlBody = xmlConvert.js2xml(postBodyJson);
    return fn(null, xmlBody);
  };
